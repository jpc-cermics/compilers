...
let node nature =
  {
    nature = nature;
    info = { Location.start = Parsing.symbol_start ();
...
let rhs_nodes n n' nature =
  {
    nature = nature;
    info = { Location.start = Parsing.rhs_start n;
...
%type <(Location.t Syntax.toplevel_element_desc, Location.t) Syntax.node> definition
%start definition
